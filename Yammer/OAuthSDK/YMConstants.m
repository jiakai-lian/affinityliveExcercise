...
NSString *const YAMMER_AUTH_REDIRECT_URI = @"comabccorpyammer1://our.custom.uri";

// Put your Yammer App's Client ID here
NSString *const YAMMER_APP_CLIENT_ID = @"Pg3F5NxiWtCOmIyVZzxFA";
...
NSString *const YAMMER_APP_CLIENT_SECRET = @"0HZXnTbfKXubBU7IG7AWQ8BzTqdBAkWKz1sFVWhMk";
...
NSString *const YMYammerSDKPostFeedDidCompleteNotification = @"YMYammerSDKPostFeedDidCompleteNotification";
NSString *const YMYammerSDKPostFeedDidFailNotification = @"YMYammerSDKPostFeedDidFailNotification";
